 ...
 *
 * <p>fix the bug when remove a fragment</p>
 *
 ...
 *      complete}
 */
public abstract class FragmentStatePagerAdapterFix extends PagerAdapter {
    ...
    public FragmentStatePagerAdapterFix(FragmentManager fm) {
        mFragmentManager = fm;
    }
    ...
    abstract public int getItemPosition(Object object);
